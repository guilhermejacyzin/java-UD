public class Au27FuncoesMatematicas {
    public static void main(String[] args) {
        //  A = Math.sqrt(x) = Variável "A" recebe Raíz quadrada de x
        //  A = Math.pow(x, y) = Variável "A" recebe Resultado de x elevado a y
        //  A = Math.abs(x) = Variável "A" recebe Recebe valor absoluto de x (tirar o negativo caso exista)
